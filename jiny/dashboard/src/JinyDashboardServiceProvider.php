...
class JinyDashboardServiceProvider extends ServiceProvider
{
    private $package = "jinydash";
    ...
    public function register()
    {
        ...
        $this->app->afterResolving(BladeCompiler::class, function () {
            // 데쉬보드
            Livewire::component('DashTable', \Jiny\Dashboard\Http\Livewire\DashTable::class);
