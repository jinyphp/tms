...
<footer id="page-footer" class="bg-white">
    <div class="container px-4 py-16 mx-auto xl:max-w-7xl lg:px-8 lg:py-32">
            ...
            <div class="space-y-6">
                ...
                <form onsubmit="return false;" class="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:space-x-2">
                    <div class="sm:grow">
                        ...
                        <input
                            class="block w-full py-2 text-sm leading-5 placeholder-gray-400 border border-gray-200 rounded focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
        ...
        <hr class="my-10">
        <div
            class="flex flex-col space-y-6 text-sm text-center md:flex-row-reverse md:justify-between md:space-y-0 md:text-left">
            <nav class="space-x-4">
                <a href="javascript:void(0)" class="text-gray-400 hover:text-indigo-600">
                    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="inline-block w-5 h-5 icon-twitter">
                        <path
                ...
                <a href="javascript:void(0)" class="text-gray-400 hover:text-indigo-600">
                    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="inline-block w-5 h-5 icon-facebook">
                        <path
                ...
                <a href="javascript:void(0)" class="text-gray-400 hover:text-indigo-600">
                    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="inline-block w-5 h-5 icon-instagram">
                        <path
                ...
                <a href="javascript:void(0)" class="text-gray-400 hover:text-indigo-600">
                    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="inline-block w-5 h-5 icon-github">
                        <path
