...
<li class="nav-item">
    <a href="environment-setup.html" class="nav-link">Environment setup</a>
</li>
<li class="nav-item">
    <a href="working-with-gulp.html" class="nav-link">Working with Gulp</a>
</li>
<li class="nav-item">
    <a href="compiled-files.html" class="nav-link">Compiled Files</a>
</li>
<li class="nav-item">
    <a href="file-structure.html" class="nav-link">File Structure</a>
</li>
<li class="nav-item">
    <a href="resources-assets.html" class="nav-link">Resources & assets</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="advance-forms.html" class="nav-link">
        Advance Forms
    </a>
</li>
<li class="nav-item">
    <a href="bootstrap-select.html" class="nav-link">
        Bootstrap Select
    </a>
</li>

<li class="nav-item">
    <a href="dropzone.html" class="nav-link">
        Dropzone
    </a>
</li>
<li class="nav-item">
    <a href="flatpickr.html" class="nav-link">
        Datepicker
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="inputmask.html" class="nav-link">
        Inputmask
    </a>
</li>
<li class="nav-item">
    <a href="quill-editor.html" class="nav-link">
        Quill Editor
    </a>
</li>
<li class="nav-item">
    <a href="tagify.html" class="nav-link">
        Tagify
    </a>
</li>
<li>
...
<li class="nav-item">
    <a href="accordions-snippet.html" class="nav-link">
        Accordions
    </a>
</li>
<li class="nav-item">
    <a href="card-snippet.html" class="nav-link">
        Card
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="client-snippet.html" class="nav-link">
        Clients
    </a>
</li>
<li class="nav-item">
    <a href="cta-snippet.html" class="nav-link">
        CTA
    </a>
</li>
<li class="nav-item">
    <a href="features-snippet.html" class="nav-link">
        Features
    </a>
</li>
<li class="nav-item">
    <a href="hero-snippet.html" class="nav-link">
        Hero
    </a>
</li>
<li class="nav-item">
    <a href="image-snippet.html" class="nav-link">
        Image
    </a>
</li>
<li class="nav-item">
    <a href="intigration-snippet.html" class="nav-link">
        Intigrations
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="slider-snippet.html" class="nav-link">
        Slider
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="tables-snippet.html" class="nav-link">
        Tables
    </a>
</li>
<li class="nav-item">
    <a href="team-snippet.html" class="nav-link">
        Team
    </a>
</li>
<li class="nav-item">
    <a href="testimonials-snippet.html" class="nav-link">
        Testimonials
    </a>
</li>
<li class="nav-item">
